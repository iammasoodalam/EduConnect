  ...
  <?php
    ...
    if($stmt && $phonestmt){
      ...
      if($stmt->execute() && $phonestmt->execute()){
        ...
        <table>
          <tr><th>Field</th><th>Value</tr>
          <tr><td>Enrollment</td><td><?php echo $enrollment; ?></td></tr>
          <tr><td>Faculty No.</td><td><?php echo $faculty; ?></td></tr>
          <tr><td>Student's Name</td><td><?php echo $studentName; ?></td></tr>
          <tr><td>Father's Name</td><td><?php echo $fathersName; ?></td></tr>
          <tr><td>Email</td><td><?php echo $emailId; ?></td></tr>
          <tr><td>Phone</td><td><?php echo $phone; ?></td></tr>
          <tr><td>Date of birth</td><td><?php echo $dateOfBirth; ?></td></tr>
          <tr><td>Password</td><td><?php echo $password; ?></td></tr>
          <tr><td>Join Date</td><td><?php echo $joinDate; ?></td></tr>
