    ...
    if($stmt && $phonestmt){
      ...
      if($stmt->execute()&& $stmt->close()){
        ...
        <table>
          ...
          <tr><td>Name</td><td><?php echo $professorName; ?></td></tr>
          <tr><td>Qualification</td><td><?php echo $qualification; ?></td></tr>
          <tr><td>Email ID</td><td><?php echo $profEmailId; ?></td></tr>
          <tr><td>Phone</td><td><?php echo $profPhone; ?></td></tr>
          <tr><td>Password</td><td><?php echo $profPassword; ?></td></tr>
          <tr><td>Join date</td><td><?php echo $profJoinDate; ?></td></tr>
          <tr><td>Address</td><td><?php echo $profAddress; ?></td></tr>
        </table>
        <?php
      }else{
        ?>
