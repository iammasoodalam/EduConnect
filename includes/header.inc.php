      ...
      <nav>
        ...
        ?>
          ...
          <ul class="login-option">
            <li onclick="toStudent()">Student</li>
            <li onclick="toProfessor()">Professor</li>
            <li onclick="toAdmin()">Admin</li>
          </ul>
          <?php
        } else {
          ...
          ?>
            <ul class="primary-nav">
              <li onclick="toHome()">Home</li>
              <li onclick="toAssignment()">Assignment</li>
              <li onclick="toLectureNotes()">Lecture Notes</li>
              <li onclick="toUpload()">Upload</li>
          ...
          ?>
            <ul class="primary-nav">
              <li id="nav-stu">Student</li>
              <li id="nav-pro">Professor</li>
